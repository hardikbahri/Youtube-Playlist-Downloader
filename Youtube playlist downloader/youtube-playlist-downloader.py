...
def download_playlist():
    ...
    for url in playlist:
        YouTube(url).streams.filter(type='video',progressive=True,file_extension='mp4').first().download()



download_folder = input("enter name of the artist: \n")
def move():
    sourcepath = './'
    ...
    destinationpath = download_folder
